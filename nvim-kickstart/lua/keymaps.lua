...
-- Diagnostic keymaps
vim.keymap.set('n', '<leader>xx', vim.diagnostic.setloclist, { desc = 'Open diagnostic Quickfi[xx] list' })
...
vim.keymap.set('n', '<leader>e', '<cmd>Neotree<CR>', { desc = 'NeoTree reveal', silent = true })
